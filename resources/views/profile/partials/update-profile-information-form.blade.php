    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <select id="usertype" name="usertype" class="block mt-1 w-full" required>
                ...
                <option value="internal" {{ old('usertype', $user->usertype) === 'internal' ? 'selected' : '' }}>Internal User</option>
                <option value="external" {{ old('usertype', $user->usertype) === 'external' ? 'selected' : '' }}>External User</option>
            </select>
            <x-input-error class="mt-2" :messages="$errors->get('usertype')" />
        </div>

    
        <div class="{{ old('usertype', $user->usertype) === 'internal' ? '' : 'hidden' }}" id="department-field">
        ...
        <div class="{{ old('usertype', $user->usertype) === 'external' ? '' : 'hidden' }}" id="company-field">
